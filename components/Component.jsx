...
const Component = (props) => {
  ...
  useEffect(()=>{
    // console.log("c "+components[0].html)
  },[components])
          ...
          <div key={index} className="my-5 bg-blue-500 p-5">
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: `<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1"><style>${code.css}</style></head><body>${code.html}</body>
        ...
        <div className="editor-container">
          {
            openedEditor === 'html' ? (
              ...
              value={css}
              setEditorState={setCssCode}
            />
            ) : (
              <Editor
              value={js}
              setEditorState={setJsCode}
            />
            )
          }
        </div>
